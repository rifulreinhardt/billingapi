...
namespace billingapi
{
    public class Startup
    {
        ...
        {
            services.Configure<BillingDbSettings>(
                    Configuration.GetSection(nameof(BillingDbSettings)));

            services.AddSingleton<IBillingDbSettings>(sp =>
                sp.GetRequiredService<IOptions<BillingDbSettings>>().Value);
